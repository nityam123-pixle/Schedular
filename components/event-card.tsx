  ...
  return (
    <Card 
        ...
        <CardFooter className='flex gap-2'>
            ...
            <Button variant={"destructive"} className='flex items-center' onClick={handleDelete} disabled={!!loading}><Trash className='mr-2 size-4' />{loading ? "Deleting..." : "Delete"}</Button>
        </CardFooter>
        }
    </Card>
  )
